...
bracket parameter is the cost decision: a bare ID resolves to Fast at ~6x the token price, which
a dry run caught); the approval gate stays in the main conversation. Say:
